const tableData = [
  {
    sno: "1",
    description: "Cleaning Flat Fillet (8 rows)",
    specification: "1022 x 32 mm",
    qty: "1 pc",
  },
  {
    sno: "1A",
    description: "Stripping Fillet DS - 609 (MK6)",
    specification: "11.0 mtrs x 40 mm",
    qty: "11.0 mtrs",
  },
  {
    sno: "2",
    description: "Stripping Flat Fillet (10 rows)",
    specification: "1022 x 32 mm",
    qty: "1 pc",
  },
  {
    sno: "2A",
    description: "Cleaning Fillet DP 18 - 1 (MK6)",
    specification: "12.5 mtrs x 28 mm",
    qty: "12.5 mtrs",
  },
  {
    sno: "3",
    description: "Dicky Fillet",
    specification: "16.0 mtrs x 20 mm",
    qty: "16.0 mtrs",
  },
];
const CrosrolM4 = () => {
