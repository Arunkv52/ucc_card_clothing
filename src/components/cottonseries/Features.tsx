      ...
      <div className='features md:px-20'>
        ...
        <div className="w-2xl py-2">
          <p className="text-base font-semibold leading-6 text-[#000000] md:mt-3">
            ...
            tip - better life and consistency in sliver quality. Effective
            opening of neps in cotton fibre - Yields better NRE%. Minimum
            maintenance - Lesser number of re-sharpening.
          </p>
        </div>
      </div>
    </>
