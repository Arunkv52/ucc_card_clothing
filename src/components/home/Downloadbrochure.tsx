    ...
    <>
      <div className='md:flex md:gap-20 md:px-10 md:py-30 py-20 px-3 download-bg relative overflow-hidden '>
        ...
        <div className='md:w-1/2 w-full'>
          <h6 className='md:text-2xl text-2xl font-light text-white leading-tight border-l border-t border-white rounded-2xl md:max-w-fit max-w-fit py-5 px-5'>
